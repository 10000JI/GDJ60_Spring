		...
		<form class="col-md-7" action="./update" method="post" enctype="multipart/form-data">
			...
			<div class="mb-3">
				...
				<c:if test="${not empty member}">
					<input type="text" name="writer" class="form-control" id="writer" value="${dto.writer}" readonly>
				</c:if>
			...
			<div class="mb-3">
				...
				<input type="text" name="title" class="form-control" id="title" placeholder="제목 입력" value="${dto.title}">
			</div>
	
			<div class="mb-3">
				<label for="contents" class="form-label">상세내용</label>
				<textarea name="contents" class="form-control" id="contents" placeholder="설명입력" rows="7" >${dto.contents}</textarea>
			</div>
